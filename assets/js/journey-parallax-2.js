// Journey2 Section - Parallax layer animation for testing (Copy of journey-parallax.js)
class JourneyParallax2 {
    constructor() {
        this.currentIndex = -1;
        this.currentSVG = null;
        this.educationCount = 6; // Number of education levels
        this.imageContainer = document.getElementById('journey-images-2');
    }
...
// Initialize journey2 parallax
const journeyParallax2 = new JourneyParallax2();

// Load initial image
journeyParallax2.loadSVG(0);

// This will be called from journey-2.js in the scroll event
window.updateJourneyParallax2 = function(scrollRatio, educationIndex) {
    // Load the appropriate image based on education index
    journeyParallax2.loadSVG(educationIndex);

    // Update parallax animation based on scroll ratio within this education section
    journeyParallax2.updateParallax(scrollRatio);
};
